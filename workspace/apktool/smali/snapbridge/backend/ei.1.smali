.class public final Lsnapbridge/backend/ei;
.super LG3/h;
.source "SourceFile"
...
.method public constructor <init>(Lcom/raizlabs/android/dbflow/config/GeneratedDatabaseHolder;Lcom/raizlabs/android/dbflow/config/g;)V
    ...
    .line 11
    .line 12
    iput-object p1, p0, Lsnapbridge/backend/ei;->a:Lx3/b;
...
# virtual methods
.method public final a(LI3/e;Lsnapbridge/backend/di;I)V
    .locals 4

    .line 1
    iget-object v0, p2, Lsnapbridge/backend/di;->b:Ljava/lang/String;
    ...
    .line 4
    :goto_0
    iget-object v0, p2, Lsnapbridge/backend/di;->c:Ljava/util/Date;

    if-eqz v0, :cond_1

    .line 5
    iget-object v1, p0, Lsnapbridge/backend/ei;->a:Lx3/b;
    ...
    .line 8
    iget-wide v1, p2, Lsnapbridge/backend/di;->d:D
    ...
    .line 10
    iget-wide v0, p2, Lsnapbridge/backend/di;->e:D
...
.method public final a(Landroid/content/ContentValues;Lsnapbridge/backend/di;)V
    .locals 3
    ...
    .line 13
    sget-object v0, Lsnapbridge/backend/fi;->b:LC3/f;
    ...
    .line 14
    iget-object v1, p2, Lsnapbridge/backend/di;->b:Ljava/lang/String;
    ...
    .line 19
    sget-object v1, Lsnapbridge/backend/fi;->c:LC3/f;
    ...
    .line 20
    :cond_2
    sget-object v0, Lsnapbridge/backend/fi;->c:LC3/f;
    ...
    .line 21
    :goto_2
    sget-object v0, Lsnapbridge/backend/fi;->d:LC3/b;
    ...
    .line 24
    sget-object v0, Lsnapbridge/backend/fi;->e:LC3/b;
    ...
    .line 25
    iget-wide v1, p2, Lsnapbridge/backend/di;->e:D
...
.method public final bindToContentValues(Landroid/content/ContentValues;LG3/g;)V
    ...
    .line 1
    check-cast p2, Lsnapbridge/backend/di;

    .line 2
    .line 3
    sget-object v0, Lsnapbridge/backend/fi;->a:LC3/e;
    ...
    .line 17
    .line 18
    invoke-virtual {p0, p1, p2}, Lsnapbridge/backend/ei;->a(Landroid/content/ContentValues;Lsnapbridge/backend/di;)V
...
.method public final bridge synthetic bindToInsertStatement(LI3/e;LG3/g;I)V
    ...
    .line 2
    .line 3
    invoke-virtual {p0, p1, p2, p3}, Lsnapbridge/backend/ei;->a(LI3/e;Lsnapbridge/backend/di;I)V
...
.method public final bindToStatement(LI3/e;LG3/g;)V
    ...
    .line 10
    .line 11
    invoke-virtual {p0, p1, p2, v2}, Lsnapbridge/backend/ei;->a(LI3/e;Lsnapbridge/backend/di;I)V
...
.method public final exists(LG3/g;LI3/f;)Z
    ...
    .line 2
    check-cast p1, Lsnapbridge/backend/di;
    ...
    .line 29
    .line 30
    const-class v6, Lsnapbridge/backend/di;
    ...
    .line 39
    .line 40
    sget-object v6, Lsnapbridge/backend/fi;->a:LC3/e;
...
.method public final getAllColumnProperties()[LC3/c;
    ...
    .line 3
    .line 4
    sget-object v1, Lsnapbridge/backend/fi;->a:LC3/e;
    ...
    .line 8
    .line 9
    sget-object v1, Lsnapbridge/backend/fi;->b:LC3/f;
    ...
    .line 18
    .line 19
    sget-object v1, Lsnapbridge/backend/fi;->d:LC3/b;
    ...
    .line 23
    .line 24
    sget-object v1, Lsnapbridge/backend/fi;->e:LC3/b;
...
.method public final getCompiledStatementQuery()Ljava/lang/String;
    ...
    .line 1
    const-string v0, "INSERT INTO `wifi_station_last_sync_locations`(`id`,`registeredCameraGuid`,`synchronizedAt`,`latitude`,`longitude`) VALUES (?,?,?,?,?)"
...
.method public final getCreationQuery()Ljava/lang/String;
    ...
    .line 2
    .line 3
    const-string v1, "CREATE TABLE IF NOT EXISTS `wifi_station_last_sync_locations`(`id` INTEGER PRIMARY KEY AUTOINCREMENT,`registeredCameraGuid` TEXT,`synchronizedAt` INTEGER NOT NULL,`latitude` REAL NOT NULL,`longitude` REAL NOT NULL, FOREIGN KEY(`registeredCameraGuid`) REFERENCES "
...
.method public final getInsertStatementQuery()Ljava/lang/String;
    ...
    .line 1
    const-string v0, "INSERT INTO `wifi_station_last_sync_locations`(`registeredCameraGuid`,`synchronizedAt`,`latitude`,`longitude`) VALUES (?,?,?,?)"
...
.method public final getModelClass()Ljava/lang/Class;
    ...
    .line 1
    const-class v0, Lsnapbridge/backend/di;
...
.method public final getProperty(Ljava/lang/String;)LC3/a;
    ...
    .line 84
    :pswitch_0
    sget-object p1, Lsnapbridge/backend/fi;->b:LC3/f;
    ...
    .line 87
    :pswitch_1
    sget-object p1, Lsnapbridge/backend/fi;->d:LC3/b;
    ...
    .line 90
    :pswitch_2
    sget-object p1, Lsnapbridge/backend/fi;->a:LC3/e;
    ...
    .line 93
    :pswitch_3
    sget-object p1, Lsnapbridge/backend/fi;->c:LC3/f;
    ...
    .line 96
    :pswitch_4
    sget-object p1, Lsnapbridge/backend/fi;->e:LC3/b;
    ...
    :sswitch_data_0
    .sparse-switch
        -0x2c6bcb0f -> :sswitch_4
        -0x19825787 -> :sswitch_3
        0x2d3a45 -> :sswitch_2
...
.method public final getTableName()Ljava/lang/String;
    ...
    .line 1
    const-string v0, "`wifi_station_last_sync_locations`"
...
.method public final loadFromCursor(Landroid/database/Cursor;LG3/g;)V
    ...
    .line 48
    iput-object v0, p2, Lsnapbridge/backend/di;->b:Ljava/lang/String;
    ...
    .line 51
    :cond_1
    iput-object v2, p2, Lsnapbridge/backend/di;->b:Ljava/lang/String;
    ...
    .line 66
    .line 67
    iget-object v2, p0, Lsnapbridge/backend/ei;->a:Lx3/b;
    ...
    .line 73
    iput-object v0, p2, Lsnapbridge/backend/di;->c:Ljava/util/Date;
    ...
    .line 76
    :cond_2
    iput-object v2, p2, Lsnapbridge/backend/di;->c:Ljava/util/Date;
    ...
    .line 98
    iput-wide v4, p2, Lsnapbridge/backend/di;->d:D
    ...
    .line 101
    :cond_3
    iput-wide v2, p2, Lsnapbridge/backend/di;->d:D
    ...
    .line 121
    iput-wide v0, p2, Lsnapbridge/backend/di;->e:D
    ...
    .line 124
    :cond_4
    iput-wide v2, p2, Lsnapbridge/backend/di;->e:D
...
.method public final newInstance()LG3/g;
    ...
    .line 1
    new-instance v0, Lsnapbridge/backend/di;

    .line 2
    .line 3
    invoke-direct {v0}, Lsnapbridge/backend/di;-><init>()V
