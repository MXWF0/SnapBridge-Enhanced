.class public final Lsnapbridge/backend/T5;
...
.field public final synthetic d:Lsnapbridge/backend/V5;


# direct methods
.method public constructor <init>(Lsnapbridge/backend/V5;Lcom/nikon/snapbridge/cmru/backend/data/repositories/camera/imagemanagement/c;Ljava/util/concurrent/CountDownLatch;Z)V
    .locals 0

    .line 1
    iput-object p1, p0, Lsnapbridge/backend/T5;->d:Lsnapbridge/backend/V5;

    .line 2
    .line 3
    iput-object p2, p0, Lsnapbridge/backend/T5;->a:Lcom/nikon/snapbridge/cmru/backend/data/repositories/camera/imagemanagement/c;

    .line 4
    .line 5
    iput-object p3, p0, Lsnapbridge/backend/T5;->b:Ljava/util/concurrent/CountDownLatch;

    .line 6
    .line 7
    iput-boolean p4, p0, Lsnapbridge/backend/T5;->c:Z
...
.method public final onComplete(Lcom/nikon/snapbridge/cmru/ptpclient/actions/AsyncAction;)V
    ...
    .line 11
    :try_start_0
    iget-object p1, p0, Lsnapbridge/backend/T5;->d:Lsnapbridge/backend/V5;
    ...
    .line 28
    :goto_0
    iget-object p1, p0, Lsnapbridge/backend/T5;->b:Ljava/util/concurrent/CountDownLatch;
    ...
    .line 34
    :goto_1
    iget-object v0, p0, Lsnapbridge/backend/T5;->b:Ljava/util/concurrent/CountDownLatch;
...
.method public final onInterrupted(Lcom/nikon/snapbridge/cmru/ptpclient/actions/AsyncAction;)V
    ...
    .line 12
    .line 13
    iget-object v2, p0, Lsnapbridge/backend/T5;->d:Lsnapbridge/backend/V5;
    ...
    .line 84
    :try_start_0
    iget-object v1, p0, Lsnapbridge/backend/T5;->d:Lsnapbridge/backend/V5;
    ...
    .line 87
    .line 88
    iget-object v1, p0, Lsnapbridge/backend/T5;->a:Lcom/nikon/snapbridge/cmru/backend/data/repositories/camera/imagemanagement/c;
    ...
    .line 98
    .line 99
    const-string v2, "Encountered unknown error on receiveOriginalImage interrupted callback."
...
.method public final onUpdate(Lcom/nikon/snapbridge/cmru/ptpclient/actions/AsyncAction;Ljava/lang/Object;)V
    ...
    .line 3
    :try_start_0
    iget-object v0, p0, Lsnapbridge/backend/T5;->a:Lcom/nikon/snapbridge/cmru/backend/data/repositories/camera/imagemanagement/c;

    .line 4
    .line 5
    iget-boolean v1, p0, Lsnapbridge/backend/T5;->c:Z

    .line 6
    .line 7
    invoke-interface {v0, p2, v1}, Lcom/nikon/snapbridge/cmru/backend/data/repositories/camera/imagemanagement/c;->a([BZ)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
