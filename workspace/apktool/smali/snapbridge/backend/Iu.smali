.class public final Lsnapbridge/backend/Iu;
.super Lsnapbridge/backend/e;
.source "SourceFile"


# static fields
.field public static final b:Lsnapbridge/backend/Eu;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lsnapbridge/backend/Eu;

    invoke-direct {v0}, Lsnapbridge/backend/Eu;-><init>()V

    sput-object v0, Lsnapbridge/backend/Iu;->b:Lsnapbridge/backend/Eu;
...
.method public constructor <init>(Landroid/content/Context;Lsnapbridge/backend/zg;)V
    ...
    .line 10
    .line 11
    const-string v0, "Q2090_V1.00.json"
    ...
    .line 15
    .line 16
    sget-object p1, Lcom/nikon/snapbridge/cmru/backend/presentation/u2220/cameradevice/entity/SensorType;->DX_APSC:Lcom/nikon/snapbridge/cmru/backend/presentation/u2220/cameradevice/entity/SensorType;

    .line 17
    .line 18
    iput-object p1, p0, Lsnapbridge/backend/Iu;->a:Lcom/nikon/snapbridge/cmru/backend/presentation/u2220/cameradevice/entity/SensorType;
...
.method public final createCaptureParameterList(Lcom/nikon/snapbridge/cmru/backend/presentation/u2220/cameradevice/entity/parameter/capture/CaptureSettingType;Ljava/util/List;)LM3/e;
    ...
    .line 10
    .line 11
    sget-object v0, Lsnapbridge/backend/Fu;->b:[I
    ...
    .line 21
    .line 22
    invoke-static {p2}, Lsnapbridge/backend/ts;->a(Ljava/util/List;)Ljava/util/ArrayList;
...
.method public final createDeviceParameterList(Lcom/nikon/snapbridge/cmru/backend/presentation/u2220/cameradevice/entity/parameter/device/DeviceSettingType;Ljava/util/List;)LM3/e;
    ...
    .line 10
    .line 11
    sget-object v0, Lsnapbridge/backend/Fu;->a:[I
    ...
    .line 27
    :pswitch_0
    invoke-static {p2}, Lsnapbridge/backend/ts;->e(Ljava/util/List;)Ljava/util/ArrayList;
    ...
    .line 38
    :pswitch_1
    invoke-static {p2}, Lsnapbridge/backend/ts;->g(Ljava/util/List;)Ljava/util/ArrayList;
    ...
    .line 48
    :pswitch_2
    invoke-static {p2}, Lsnapbridge/backend/ts;->i(Ljava/util/List;)Ljava/util/ArrayList;
    ...
    .line 58
    :pswitch_3
    invoke-static {p2}, Lsnapbridge/backend/ts;->l(Ljava/util/List;)Ljava/util/ArrayList;
    ...
    .line 68
    :pswitch_4
    invoke-static {p2}, Lsnapbridge/backend/ts;->k(Ljava/util/List;)Ljava/util/ArrayList;
...
.method public final filterSupportedCaptureParameter(Lcom/nikon/snapbridge/cmru/backend/presentation/u2220/cameradevice/entity/parameter/capture/CaptureSettingType;Ljava/util/List;)Lsnapbridge/backend/dw;
    ...
    .line 42
    new-instance v0, Lsnapbridge/backend/Gu;

    .line 43
    .line 44
    invoke-direct {v0, p2}, Lsnapbridge/backend/Gu;-><init>(Ljava/util/List;)V
...
.method public final filterSupportedDeviceParameter(Lcom/nikon/snapbridge/cmru/backend/presentation/u2220/cameradevice/entity/parameter/device/DeviceSettingType;Ljava/util/List;)Lsnapbridge/backend/dw;
    ...
    .line 43
    new-instance v0, Lsnapbridge/backend/Hu;

    .line 44
    .line 45
    invoke-direct {v0, p2}, Lsnapbridge/backend/Hu;-><init>(Ljava/util/List;)V
...
.method public final getSensorType()Lcom/nikon/snapbridge/cmru/backend/presentation/u2220/cameradevice/entity/SensorType;
    ...
    .line 1
    iget-object v0, p0, Lsnapbridge/backend/Iu;->a:Lcom/nikon/snapbridge/cmru/backend/presentation/u2220/cameradevice/entity/SensorType;
