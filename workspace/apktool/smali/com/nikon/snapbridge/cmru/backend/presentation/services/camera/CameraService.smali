...
.method public static isCameraImageTransferResumeAllowed()Z
    .locals 2

    sget-object v0, Lcom/nikon/snapbridge/cmru/backend/presentation/services/camera/CameraService;->U:Lcom/nikon/snapbridge/cmru/backend/presentation/services/camera/CameraService;

    if-eqz v0, :resume_blocked
    ...
    iget-boolean v1, v0, Lcom/nikon/snapbridge/cmru/backend/presentation/services/camera/EnhancedPowerReceiver;->l:Z

    if-eqz v1, :resume_blocked

    iget-boolean v1, v0, Lcom/nikon/snapbridge/cmru/backend/presentation/services/camera/EnhancedPowerReceiver;->h:Z

    if-eqz v1, :resume_allowed

    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Lcom/nikon/snapbridge/cmru/backend/presentation/services/camera/EnhancedPowerReceiver;->notifyTransferPauseState(Z)V
...
.method public onCreate()V
    ...
    new-instance v0, Lcom/nikon/snapbridge/cmru/backend/presentation/services/camera/CameraService$ConnectionStatusListener;

    invoke-direct {v0, p0}, Lcom/nikon/snapbridge/cmru/backend/presentation/services/camera/CameraService$ConnectionStatusListener;-><init>(Lcom/nikon/snapbridge/cmru/backend/presentation/services/camera/CameraService;)V

    iput-object v0, p0, Lcom/nikon/snapbridge/cmru/backend/presentation/services/camera/CameraService;->X:Lcom/nikon/snapbridge/cmru/backend/presentation/services/camera/ICameraActiveCameraConnectionStatusListener;

    iget-object v1, p0, Lcom/nikon/snapbridge/cmru/backend/presentation/services/camera/CameraService;->j:Lsnapbridge/backend/l7;

    iget-object v1, v1, Lsnapbridge/backend/l7;->c:Lsnapbridge/backend/S7;

    iget-object v2, p0, Lcom/nikon/snapbridge/cmru/backend/presentation/services/camera/CameraService;->X:Lcom/nikon/snapbridge/cmru/backend/presentation/services/camera/ICameraActiveCameraConnectionStatusListener;

    invoke-virtual {v1, v2}, Lsnapbridge/backend/S7;->a(Lcom/nikon/snapbridge/cmru/backend/presentation/services/camera/ICameraActiveCameraConnectionStatusListener;)V

    invoke-virtual {v1}, Lsnapbridge/backend/S7;->b()V
    ...
    if-lt v2, v3, :legacy_system_register
    ...
    goto :system_registered

    :legacy_system_register
    invoke-virtual {p0, v0, v1}, Landroid/content/Context;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;
    move-result-object v2

    :system_registered
    invoke-virtual {v0, p0, v2}, Lcom/nikon/snapbridge/cmru/backend/presentation/services/camera/EnhancedPowerReceiver;->onReceive(Landroid/content/Context;Landroid/content/Intent;)V

    new-instance v1, Landroid/content/IntentFilter;

    invoke-direct {v1}, Landroid/content/IntentFilter;-><init>()V

    const-string v2, "com.nikon.snapbridge.cmru.ENHANCED_POWER_CHANGED"
    ...
    const-string v2, "com.nikon.snapbridge.cmru.backend.camera.ENHANCED_TRANSFER_POWER_QUERY"
    ...
    if-lt v2, v3, :legacy_app_register
...
.method public onDestroy()V
    ...
    iget-object v0, p0, Lcom/nikon/snapbridge/cmru/backend/presentation/services/camera/CameraService;->X:Lcom/nikon/snapbridge/cmru/backend/presentation/services/camera/ICameraActiveCameraConnectionStatusListener;

    if-eqz v0, :connection_listener_removed

    iget-object v2, p0, Lcom/nikon/snapbridge/cmru/backend/presentation/services/camera/CameraService;->j:Lsnapbridge/backend/l7;

    iget-object v2, v2, Lsnapbridge/backend/l7;->c:Lsnapbridge/backend/S7;

    invoke-virtual {v2, v0}, Lsnapbridge/backend/S7;->b(Lcom/nikon/snapbridge/cmru/backend/presentation/services/camera/ICameraActiveCameraConnectionStatusListener;)V

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/nikon/snapbridge/cmru/backend/presentation/services/camera/CameraService;->X:Lcom/nikon/snapbridge/cmru/backend/presentation/services/camera/ICameraActiveCameraConnectionStatusListener;

    :connection_listener_removed
