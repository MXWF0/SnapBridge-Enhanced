...
### 连接与重连
- **真实连接状态**：主页状态面板统一读取 BLE、认证、Wi-Fi/PTP、远程与自动传图真实回调
...
- **低电量保护**：同时监听相机与手机电量，阈值可选 10 / 15 / 20 / 30%，低电量时暂停新的传图任务，电量恢复后自动恢复（含 5% 迟滞区间）
- **状态分离**：手动暂停与省电暂停互不覆盖
...
👉 **[前往 Releases 下载最新版本](https://github.com/MXWF0/SnapBridge-Enhanced/releases/latest)**
...
- 修改方式：基于官方 APK 使用 **Apktool 2.11.1 + AAPT2** 在 Smali 层二次开发（Smali 98.7% / HTML 1.3%）
...
<details>
<summary><b>v1.3</b>（2026-09-18）</summary>

- 修复启动闪退
- 修改常驻通知逻辑，关闭后同一状态不重挂
- 自动传图失败写回持久化重试次数；相机离线暂停退避计时
- 调整后台重连时间
- 新增断点续传
- 修复失败任务可能被重复下载的问题
...
<details>
<summary><b>v1.2</b>（2026-09-13）</summary>
...
- 原应用版权归原作者及尼康公司所有，本项目仅供学习与技术研究使用，请于24小时内删除。
